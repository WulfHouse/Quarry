...
- **SSOT**: Single Source of Truth (docs/SSOT.txt - the vision document)
...
**Statement:** Pyrite defines a semantic "Core" subset for learners that provides a complete, practical programming environment while forbidding advanced features like unsafe blocks or manual allocators. This is enforced via compiler modes (pyritec --core-only) and linter levels (quarry lint --beginner).
...
**Statement:** Every error code (P####) maps to a detailed conceptual explanation (pyritec --explain) with correct/incorrect code examples and links to documentation.
...
- REQ-052 -> SPEC-LANG-0200
- REQ-053 -> SPEC-LANG-0200
- REQ-054 -> SPEC-LANG-0200
- REQ-055 -> SPEC-LANG-0200
- REQ-056 -> SPEC-LANG-0200
- REQ-057 -> SPEC-LANG-0200
- REQ-058 -> SPEC-LANG-0208
- REQ-059 -> SPEC-LANG-0209
- REQ-060 -> SPEC-LANG-0209
- REQ-061 -> SPEC-LANG-0200
- REQ-062 -> SPEC-LANG-0200
- REQ-063 -> SPEC-LANG-0200
- REQ-064 -> SPEC-LANG-0200
- REQ-065 -> SPEC-LANG-0200
- REQ-066 -> SPEC-LANG-0200
- REQ-067 -> SPEC-LANG-0200
- REQ-068 -> SPEC-LANG-0200
- REQ-069 -> SPEC-LANG-0200
- REQ-070 -> SPEC-LANG-0200
- REQ-071 -> SPEC-LANG-0300
- REQ-072 -> SPEC-LANG-0300
- REQ-073 -> SPEC-LANG-0300
- REQ-074 -> SPEC-LANG-0210
- REQ-075 -> SPEC-LANG-0300
...
#### SPEC-LANG-0303: Lifetime Analysis
**Kind:** LEAF
**Source:** REQ-114, REQ-115, SSOT Section 5.3
**Status:** PLANNED
**Priority:** P0
**Definition of Done:**
...
**Kind:** LEAF
**Source:** REQ-267, REQ-268, REQ-269, SSOT Section 9.1
**Status:** PLANNED
**Priority:** P1
**Definition of Done:**
- Implement generic `List[T]`, `Map[K, V]`, and `Set[T]` in the standard library.
- Ensure high performance and memory efficiency (e.g., small-string optimization, open addressing for maps).
- Support ownership-aware iteration (into_iter, iter, iter_mut).
**User-facing behavior:**
- Standard collections available without imports (prelude).
**Semantics:**
- `List` is a dynamic array (like Vec in Rust).
- `Map` is a hash map with default secure hashing.
**Errors/diagnostics:**
- Panic on out-of-bounds access (List).
**Examples:**
- Positive: `let l = List[int]([1, 2, 3]); l.push(4);`
- Negative: `let x = l[10]` (Panic)
**Tests required:**
- Unit: Exhaustive testing of collection operations and growth.
- Performance: Benchmark against C++ STL / Rust collections.
**Implementation notes:**
- File: `pyrite/stdlib/src/collections/mod.pyrite`
**Dependencies:**
- SPEC-LANG-0203, SPEC-LANG-0300
...
**User-facing behavior:**
- Run `pyritec --explain P0123` to learn about an error.
**Tests required:**
...
- **LANG:** SPEC-LANG-0002, SPEC-LANG-0003, SPEC-LANG-0004, SPEC-LANG-0005, SPEC-LANG-0009, SPEC-LANG-0101, SPEC-LANG-0201, SPEC-LANG-0202, SPEC-LANG-0203, SPEC-LANG-0204, SPEC-LANG-0205, SPEC-LANG-0206, SPEC-LANG-0501, SPEC-LANG-0301, SPEC-LANG-0303, SPEC-LANG-0304, SPEC-LANG-0305
...
- **Type System:** SPEC-LANG-0202, SPEC-LANG-0203, SPEC-LANG-0204, SPEC-LANG-0205, SPEC-LANG-0206
- **Ownership:** SPEC-LANG-0303, SPEC-LANG-0304, SPEC-LANG-0305
- **Build System:** SPEC-QUARRY-0002, SPEC-QUARRY-0003, SPEC-QUARRY-0004, SPEC-QUARRY-0005, SPEC-QUARRY-0006
- **Standard Library:** SPEC-LANG-0801, SPEC-LANG-0802, SPEC-LANG-0803, SPEC-LANG-0804, SPEC-LANG-0805, SPEC-LANG-0806
...
- **Milestones:**
  ...
  - **M3: Type System Core**
    ...
    - Included: SPEC-LANG-0201, SPEC-LANG-0202, SPEC-LANG-0203, SPEC-LANG-0206, SPEC-LANG-0211, SPEC-LANG-0212, SPEC-LANG-0213, SPEC-LANG-0214, SPEC-LANG-0215, SPEC-LANG-0216, SPEC-FORGE-0019, SPEC-FORGE-0020, SPEC-FORGE-0021, SPEC-FORGE-0022, SPEC-FORGE-0023.
    - Dependencies: M2.
...
- **Milestones:**
  ...
  - **M6: Ownership & Borrowing**
    ...
    - Included: SPEC-LANG-0300 (NODE), SPEC-LANG-0301, SPEC-LANG-0302 (NODE), SPEC-LANG-0303, SPEC-LANG-0304, SPEC-LANG-0305, SPEC-LANG-0306, SPEC-LANG-0307, SPEC-LANG-0308, SPEC-LANG-0309, SPEC-LANG-0310, SPEC-FORGE-0006.
    - Dependencies: M5.
...
- **Milestones:**
  - **M9: Standard Library Core**
    ...
    - Included: SPEC-LANG-0801, SPEC-LANG-0802, SPEC-LANG-0803.
